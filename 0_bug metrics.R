...
bug_mets<-c("Arth_Rich", "Arth_Abund", 
            ...
            "NonnatSynanth_KRich", "NonnatSynanth_Rich", "NonnatSynanth_RelRich", "NonnatSynanth_KAbund", "NonnatSynanth_Abund", "NonnatSynanth_RelAbund", 
            ...
            "Arboreal_Rich", "Arboreal_RelRich", 
            "Arboreal_Abund", "Arboreal_RelAbund", "FFG_KRich", "FFG_KAbund", 
            "Detritivore_Rich", "Detritivore_RelRich", "Detritivore_Abund", 
            "Detritivore_RelAbund", "Fungivore_Rich", "Fungivore_RelRich", 
            "Fungivore_Abund", "Fungivore_RelAbund", "DetrFung_Rich", "DetrFung_RelRich", 
            "DetrFung_Abund", "DetrFung_RelAbund", "Predator_Rich", "Predator_RelRich", 
            "Predator_Abund", "Predator_RelAbund", "FFG_d_KRich", "FFG_d_KAbund", 
            "PredatorGround_Rich", "PredatorGround_RelRich", "PredatorGround_Abund", 
            "PredatorGround_RelAbund", "BodySize_KRich", "BodySize_KAbund", 
            "BodySizeSmall_Rich", "BodySizeSmall_RelRich", "BodySizeSmall_Abund", 
            "BodySizeSmall_RelAbund", "BodySizeMedium_Rich", "BodySizeMedium_RelRich", 
            "BodySizeMedium_Abund", "BodySizeMedium_RelAbund", "BodySizeLarge_Rich", 
            "BodySizeLarge_RelRich", "BodySizeLarge_Abund", "BodySizeLarge_RelAbund", 
            "BodySizeLargest", "BodySizeAverage", "Dispersal_KRich", "Dispersal_KAbund", 
            "DisperserPoor_Rich", "DisperserPoor_RelRich", "DisperserPoor_Abund", 
            "DisperserPoor_RelAbund", "DisperserGood_Rich", "DisperserGood_RelRich", 
            "DisperserGood_Abund", "DisperserGood_RelAbund", "TempTol_KRich", 
            "TempTol_KAbund", "TempTolHigh_Rich", "TempTolHigh_RelRich", 
            "TempTolHigh_Abund", "TempTolHigh_RelAbund", "TempTolAverage", 
            "TempTolMax")
